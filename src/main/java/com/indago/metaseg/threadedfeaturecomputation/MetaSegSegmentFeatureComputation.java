...
public class MetaSegSegmentFeatureComputation implements Runnable {
	...
	private HashMap< LabelingSegment, FeaturesRow > featuresTable = new HashMap< LabelingSegment, FeaturesRow >();
	...
	public final void run() {
		for ( final ValuePair< LabelingSegment, Integer > segment : hypothesesSet ) {
			extractFeaturesFromHypothesis( segment );
		}
	}

	public HashMap< LabelingSegment, FeaturesRow > getFeaturesTable() {
